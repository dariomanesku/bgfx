...
#ifndef BGFX_CONFIG_MAX_VERTEX_BUFFERS_PER_DRAW_CALL
#	define BGFX_CONFIG_MAX_VERTEX_BUFFERS_PER_DRAW_CALL 8
#endif // BGFX_CONFIG_MAX_VERTEX_BUFFERS_PER_DRAW_CALL
